...
popupManager = {
    ...
    /*,onScrollEvent : function (el) {

        let closeBtn = $( el ).find('.popup_close_btn_wrap');
        ...
        $(el).on('scroll', function () {
            ...
            if( $(this).scrollTop() > 0 ){
                // 스크롤을 내린 경우
                $(closeBtn).css('border-top-right-radius','0');
            } else {
                // 스크롤 시작위치에 있는 경우
                $(closeBtn).css('border-top-right-radius','5px');
            }
