...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/client/js/business/main.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/client/js/business/mainFilter.js'/>"></script>
    <script type="text/javascript" src="<c:url value='/client/js/business/mainWrite.js'/>"></script>
...
<body>
	...
	<section class="col-12 pt10 main_wrap">
		...
		<ul class="col-12 col-center mw-1390 pl20 pr20 mb30 main_info_banner_con">
			<c:forEach var="bannerList" items="${MainBannerList}">
				<li>
					<div class="col-12 main_info_banner_bg_con">
						<img src="/file/display?fileSeq=${bannerList.imgFileSeq}"/>
					</div>
					<%-- <div class="col-12 main_info_banner_contents_con">
						<div class="col-12 main_info_banner_title">
		...
		<div class="col-12 col-center mw-1390 pl20 pr20 work_pc_list_wrap hidden show-md-block">
			<div class="col-12 work_pc_list_title_con type_2">
				<div class="col-12 work_pc_list_title">구인 내역</div>
				...
				<div class="col-12 main_filter type_btn">
					...
					<div class="col-0 input_box">
						<div class="col-12 radio_style_1_con">
							<div class="col-12 radio_style_1">
