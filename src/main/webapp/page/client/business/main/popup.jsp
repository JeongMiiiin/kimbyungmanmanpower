		...
		<div class="col-12 popup_inner">
			...
			<ul class="col-12 pl20 pr20 main_filter_popup_select_con">
				...
				<li>
					...
					<a href="javascript:void(0)" class="col-12 input_box" onclick="mainFilter.open2DepthFilterPopup(1,0)"><span>카테고리를 선택해주세요.</span></a>
				</li>
			</ul>
				...
				<li>
					...
					<div class="col-12 input_box">
						<div class="col-12">
							...
							<div class="col-0 mt5 ml7 mr7 addr_text">년</div>
							...
							<div class="col-0 mt5 ml7 mr7 addr_text">월</div>
							...
							<div class="col-0 mt5 ml7 addr_text">일</div>
						</div>
						<div class="col-12 type_time">
							<select name="dateFilterStart0Hour" id="dateFilterStart0Hour" class="select_style_0">
							...
							<div class="col-0 mt5 ml7 mr7 addr_text">:</div>
							<select name="dateFilterStart0Min" id="dateFilterStart0Min" class="select_style_0">
								<option value="00">00</option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option>
								<option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option>
								<option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option>
...
<!-- 비밀번호 확인 팝업 -->
<div class="col-12 popup_style_3_wrap" id="workConfirmPasswordPopup">
	<div class="col-12 popup_con">
		<div class="col-12 popup_inner">
			<div class="col-12 popup_title_con type_2">
				<div class="col-12 popup_title">비밀번호 확인</div>
			</div>
			<div class="col-12 mb14 popup_sub_title">비밀번호를 입력해주세요!</div>
			<ul class="col-12 popup_contents_con type_2">
				<li>
					<div class="col-12 label_box">비밀번호</div>
					<div class="col-12 input_box">
						<input type="password" name="workInputPassword" id="workInputPassword" class="input_style_0" placeholder="비밀번호를 입력해주세요"/>
					</div>
				</li>
			</ul>
			<div class="col-12 mt30 pl20 pr20 pb40 popup_style_3_btn_con">
				<div class="col-12 popup_style_3_btn type_blue">
					<a href="javascript:void(0)" onclick="main.completePassword()"><span>확인</span></a>
				</div>
			</div>
		</div>
	</div>
...
<div class="col-12 popup_style_2_wrap" id="categoryFilter2DepthSelectPopup0">
	<div class="col-12 popup_con">
		<div class="col-12 popup_inner">
			<div class="col-12 mb24 popup_title_con">
				<div class="col-12 popup_title">카테고리</div>
			</div>
		...
		<div class="col-12 popup_inner">
			...
			<ul class="col-12 popup_contents_con">
				...
				<li>
					...
					<div class="col-0 input_box" id="workViewNumbers"></div>
				</li>
				<li>
			...
			<div class="col-12 mt30 pl20 pr20 pb40 popup_style_3_btn_con">
				<div class="col-12 popup_style_3_btn">
		...
		<div class="col-12 popup_inner">
			...
			<div class="col-12 pt17 pl20 pr20 popup_contents_con">
				<form class="col-12 mb50 popup_work_write_con">
					<input type="hidden" name="workMemCategory" id="workMemCategory" value="1"/>
					<input type="hidden" name="workClass" id="workClass" value="0"/>
					...
					<div class="col-12 popup_work_write">
						<div class="col-12 label_box">비밀번호</div>
						<div class="col-12 input_box">
							<input type="password" name="workPassword" id="workPassword" class="input_style_0" placeholder="비밀번호를 입력해주세요"/>
						</div>
					</div>
					<div class="col-12 popup_work_write">
						<div class="col-12 label_box">비밀번호 확인</div>
						<div class="col-12 input_box">
							<input type="password" name="workConfirmPassword" id="workConfirmPassword" class="input_style_0" placeholder="비밀번호를 다시 입력해주세요"/>
					...
					<div class="col-12 popup_work_write">
						...
						<div class="col-12 mt13 info_assist_text">시간까지는 안 적으셔도 됩니다.</div>
					</div>
					<div class="col-12 popup_work_write">
						<div class="col-12 label_box">인원</div>
						<div class="col-12 input_box">
							<select name="workNumbers" id="workNumbers" class="select_style_0">
								<option value="" disabled selected>선택해주세요</option>
								<option value="0">1 ~ 50명</option>
								<option value="1">51 ~ 100명</option>
								<option value="2">101 ~ 150명</option>
								<option value="3">150명 이상</option>
							</select>
						</div>
					</div>
					<div class="col-12 popup_work_write type_payment">
						...
						<div class="col-12 mt13 info_assist_text">안 적으셔도 됩니다.</div>
					</div>
				</form>
		...
		<div class="col-12 popup_inner">
			...
			<ul class="col-12 pl20 pr20 main_filter_popup_select_con">
				...
				<li>
					...
					<div class="col-12 label_box">카테고리</div>
					<a href="javascript:void(0)" class="col-12 input_box" onclick="mainWrite.open2DepthWritePopup(1,0)"><span>카테고리를 선택해주세요.</span></a>
				</li>
			</ul>
