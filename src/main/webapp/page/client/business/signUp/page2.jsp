...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/client/js/business/signUp2.js'/>"></script>
</head>
<body>
    ...
    <section class="col-12 col-center mw-md-635 pt40 pl20 pr20 login_wrap">
    	<div class="col-12">
			...
			<div class="col-12 btn_style_0_con">
				<a href="javascript:void(0)" class="col-12 btn_style_0 type_blue" id="signUp2CompleteBtn">
					<span>인증번호 발송</span>
				</a>
			</div>
    	</div>
