...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/client/js/business/recentPost.js'/>"></script>
    <script>
    	let footerIdx = 1;
    	let headerPcIdx = 0;
    </script>
...
<body>
    ...
    <section class="col-12 sub_wrap">
    		...
    		<div class="col-12 col-md-9">
    			<div class="col-12 mt47 work_pc_list_wrap">
    				<div class="col-12 work_pc_list_title_con">
    					<div class="col-12 work_pc_list_title">구인내역</div>
    				</div>
    				<ul class="col-12 work_pc_list_contents_con">
    					<c:forEach var="result" items="${resultList}">
		    				<c:choose>
		    					<c:when test="${result ne null}">
		    						<li onclick="window.location.href='/business/myInfo/workView?sn=${result.sn}&pageCategory=recentPost'">
    	...
    	<div class="col-12 hidden-md pl20 pr20 my_info_work_list_wrap">
    		<div class="col-12 my_info_work_list_headline">최근 구인내역</div>
