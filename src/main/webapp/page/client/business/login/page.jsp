...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/client/js/business/login.js'/>"></script>
</head>
<body>
    ...
    <section class="col-12 col-center mw-md-400 pt40 pl20 pr20 login_wrap">
    	<div class="col-12">
			...
			<form class="col-12 mb20 form_style_0_con" action="/business/loginAction" method="post" id="businessLoginForm">
				<div class="col-12 form_style_0">
					<div class="col-12 label_box">
						<label for="phoneNum">휴대 전화 번호</label>
					</div>
					<div class="col-12 input_box">
						<input type="number" id="phoneNum" name="phoneNum" class="input_style_0" placeholder="휴대 전화번호를 '-'없이 입력해주세요." pattern="\d*"/>
					</div>
				</div>
				<div class="col-12 form_style_0">
					<div class="col-12 label_box">
			...
			<ul class="col-12 mb40 login_list_con">
				<li>
					<a href="/business/findPassword">비밀번호 찾기</a>
				</li>
			</ul>
			<div class="col-12 btn_style_0_con">
				...
				<a href="/business/signUp?stepIdx=1" class="col-12 mt10 btn_style_0 type_4">
					<span>회원가입</span>
				</a>
			</div>
    	</div>
