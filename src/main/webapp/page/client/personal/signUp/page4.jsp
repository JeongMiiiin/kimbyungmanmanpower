    ...
    <section class="col-12 col-center mw-635 pt40 pl20 pr20 contents_wrap">
		...
		<form class="col-12 mb40 form_style_0_con" method="post" action="/personal/signUpAction" enctype="multipart/form-data" data-common-update-form>
			...
			<div class="col-12 form_style_0">
				...
				<div class="col-12 input_box">
					<input type="password" id="password" name="password" class="input_style_0" maxlength="15" placeholder="영문, 숫자, 특수기호 조합으로 6-15자리 이상 입력해주세요" data-common-update-essential-input="영문, 숫자, 특수기호 조합으로 6-15자리 이상 입력해주세요"/>
			...
			<div class="col-12 form_style_0 type_email">
				...
				<div class="col-12 input_box">
					...
					<select class="select_style_0" name="emailDomain">
