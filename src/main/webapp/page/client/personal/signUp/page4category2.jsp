...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/client/js/personal/signUp4.js'/>"></script>
...
<body>
    ...
    <section class="col-12 col-center mw-635 pt40 pl20 pr20 contents_wrap">
		...
		<form class="col-12 mb40 form_style_0_con" method="post" action="/personal/signUpAction" enctype="multipart/form-data" data-common-update-form>
			<input type="hidden" name="phoneNum" value="${phoneNum}"/>
			<input type="hidden" name="category" value="<%=category%>"/>
			<input type="hidden" name="permissionFileList" value=""/>
			<input type="hidden" name="healthCertificateFileList" value=""/>
			<input type="hidden" name="etcFileList" value=""/>
			<div class="col-12 form_style_0">
				<div class="col-12 label_box">
					<label for="name">이름</label>
				</div>
				<div class="col-12 input_box">
					<input type="text" id="name" name="name" class="input_style_0" placeholder="이름을 입력해주세요" data-common-update-essential-input="이름을 입력해주세요"/>
				</div>
			</div>
			<div class="col-12 form_style_0">
				<div class="col-12 label_box">
			...
			<div class="col-12 form_style_0">
				...
				<div class="col-12 mt15 sign_up_assist_text">외국인의 경우 F2, F4, F5, F6비자를 취득한 외국인에 한하여 해당 서비스를 이용할 수 있습니다.</div>
				<div class="col-12 mt15 hidden-md btn_style_0_con">
					<a href="javascript:void(0)" class="col-6 btn_style_0 type_2 kakao"><span>카카오톡 문의</span></a>
					<a href="javascript:void(0)" class="col-6 btn_style_0 type_2 phone"><span>전화 문의</span></a>
				</div>
			</div>
			<div class="col-12 form_style_0">
				<div class="col-12 label_box">
			...
			<div class="col-12 form_style_0 type_birth">
				...
				<div class="col-12 mt15 sign_up_assist_text">만 19세 이상부터 일자리 지원이 가능합니다.</div>
			</div>
			<div class="col-12 form_style_0">
				<div class="col-12 label_box">
					<span>혈압</span>
				...
				<div class="col-12 input_box">
					<select class="select_style_0" name="bloodPressure" data-common-update-essential-input="혈압을 선택해주세요" required>
						<option value="" disabled selected>혈압을 선택해주세요.</option>
						<option value="0">100이하</option>
						<option value="1">100이상 110미만</option>
						<option value="2">110이상 120미만</option>
						<option value="3">120이상 130미만</option>
						<option value="4">130이상 140미만</option>
						<option value="5">140이상 150미만</option>
						<option value="6">150이상</option>
					</select>
				</div>
				<div class="col-12 mt15 sign_up_assist_text">혈압이 150이상인 경우 의사소견서 등<br/>증빙서류 확인이 필요합니다.</div>
			</div>
			<div class="col-12 form_style_0">
				<div class="col-12 label_box">
					<span>차량유무</span>
				...
				<div class="col-12 input_box">
					<div class="col-12 radio_style_1_con">
						<div class="col-6 radio_style_1">
							<input type="radio" name="carExist" value="0" id="carExist0" checked/>
							<label for="carExist0">유</label>
						</div>
						<div class="col-6 radio_style_1">
							<input type="radio" name="carExist" value="1" id="carExist1"/>
							<label for="carExist1">무</label>
						</div>
					</div>
				</div>
			</div>
			<div class="col-12 form_style_0 type_signature">
				<div class="col-12 label_box">
					<span>전자서명</span>
				</div>
				<div class="col-12 input_box">
					<input type="hidden" name="signData" id="signData"/>
					<canvas class="signature_pad" id="signaturePad"></canvas>
					<a href="javascript:void(0)" class="signature_clear_btn" onclick="signUp4.resetSign()" id="signatureClearBtn">다시 서명</a>
				</div>
				<div class="col-12 mt15 mb15 sign_up_assist_text">전자서명은 노무비 선지급을 위한 위임장과 노무비 청구 시 사용됩니다.</div>
				<div class="col-12 btn_style_0_con">
					<a href="javascript:void(0)" class="col-12 btn_style_0 type_lightgrey" onclick="signUp4.completeSign()"><span>등록</span></a>
				</div>
			</div>
			<div class="col-12 form_style_0">
				<div class="col-12 label_box">
				...
				<div class="col-12 input_box">
					<div class="col-12 mb15">
						<select class="select_style_0" name="bankName" data-common-update-essential-input="은행명을 선택해주세요" required>
							<option value="" disabled selected>은행명을 선택해주세요.</option>
					...
					<input type="text" name="bankNum" class="input_style_0" placeholder="계좌번호를 입력해주세요" data-common-update-essential-input="계좌번호를 입력해주세요"/>
				</div>
				<div class="col-12 mt15 btn_style_0_con">
					<a href="javascript:void(0)" class="col-12 btn_style_0 type_lightgrey" onclick="signUp4.ceritifcateBankNum()"><span>인증</span></a>
				</div>
			</div>
			<div class="col-12 form_style_0">
				<div class="col-12 label_box">
				...
				<div class="col-12 input_box">
					<div class="col-12 textarea_style_0_con">
						<textarea class="textarea_style_0" placeholder="간단장점을 입력해주세요" name="simpleAdvantages"></textarea>
					</div>
				</div>
			</div>
			<div class="col-12 form_style_0">
				...
				<div class="col-12 input_box">
					<div class="col-12 file_input_style_0_con">
						<input type="file" id="permissionFile1" name="permissionFile1" data-common-file-input accept=".gif, .jpg, .png"/>
						<ul>
							<li><a href="javascript:void(0)" class="file_add_btn" data-file-insert-btn data-target-file="permissionFile1"><span>파일등록</span></a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="col-12 form_style_0">
				...
				<div class="col-12 input_box">
					<div class="col-12 file_input_style_0_con">
						<input type="file" id="healthCertificateFile1" name="healthCertificateFile1" data-common-file-input accept=".gif, .jpg, .png"/>
						<ul>
							<li><a href="javascript:void(0)" class="file_add_btn" data-file-insert-btn data-target-file="healthCertificateFile1"><span>파일등록</span></a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="col-12 form_style_0">
				...
				<div class="col-12 input_box">
					<div class="col-12 file_input_style_0_con">
						<input type="file" id="etcFile1" name="etcFile1" data-common-file-input accept=".gif, .jpg, .png"/>
						<ul>
							<li><a href="javascript:void(0)" class="file_add_btn" data-file-insert-btn data-target-file="etcFile1"><span>파일등록</span></a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="col-12 mb-md-99 btn_style_0_con hidden show-md">
			<a href="/personal/login" class="col-6 btn_style_0 type_2 type_grey"><span>취소</span></a>
