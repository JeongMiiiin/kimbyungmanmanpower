...
<head>
  ...
  <script type="text/javascript" src="https://cdn.iamport.kr/js/iamport.payment-1.2.0.js"></script>
    <script type="text/javascript" src="<c:url value='/client/js/personal/workUpdate.js'/>"></script>
    <script>
    	let footerIdx = 3;
    	let headerPcIdx = 2;
    </script>
    ...
    <section class="col-12 pt27 sub_wrap">
    	<div class="col-12 col-center mw-1390 mt-md-67 pl-md-20 pr-md-20 my_info_pc_wrap">
    		...
    		<form class="col-12 mt-md-47 col-md-9 my_info_work_view_wrap" action="/personal/myInfo/workUpdateAction" enctype="multipart/form-data" data-common-update-form>
	    		...
	    		<input type="hidden" name="workClassType" id="workClassType" value="${updateData.classType}"/>
	    		<input type="hidden" name="workMemberSn" id="workMemberSn" value="${updateData.memberSn}"/>
