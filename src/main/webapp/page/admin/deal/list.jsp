...
<head>
	...
	<script type="text/javascript" src="<c:url value='/adm/js/deal/list.js'/>"></script>
	<script>
						...
						<table class="col-12">
							...
							<tbody>
							    ...
							    <tr>
							    	...
							    	<td>
							    		<c:choose>
							    			<c:when test="${list.status eq 0 }">지급대기</c:when>
							    			<c:when test="${list.status eq 1 }">지급완료</c:when>
							    			<c:otherwise>지급취소</c:otherwise>
							    		</c:choose>
							    	</td>
