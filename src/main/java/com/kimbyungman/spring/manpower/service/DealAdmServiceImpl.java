...
@Service
public class DealAdmServiceImpl extends RootService implements DealAdmService {
	@Autowired
	private DealDao dao;
	
	//리스트 페이지 이동 (관리자)
	@Override
	public String listPage(DealDto searchDto, HttpServletRequest request, Model model) {
